...
class Spyropress {
    ...
    var $themekey = 'g9drml18r6r3b6r44q6k6tk0w8aend6yc';
    ...
    function setup_globals() {
        ...
        // Language
        $this->language_path = $this->framework_path . 'languages/';
    ...
    function setup_options() {
        ...
        foreach( $options[0] as $option => $option_meta ) {
            $key = "{$option}_settings";
            $this->options[$key] = get_option( "spyropress_{$key}" );
        }
    }
    ...
    function frontend_includes() {
        ...
        require_once ( 'components/pagination.php' ); // Wp-Page-Nav-i
        require_once ( 'shortcodes/spyropress-shortcode-init.php' ); // Load all shortcodes into system
    }
    ...
    function load_textdomain() {
        ...
        load_textdomain( $this->domain, $this->language_path . "$locale.mo" );
    ...
    function init_components() {
        ...
        foreach ( $components[0] as $component )
            require_once( $this->framework_path . 'components/' . $component . '/' . $component . '-init.php' );
    }
